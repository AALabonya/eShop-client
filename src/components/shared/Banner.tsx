...
const Banner = () => {
  ...
  <div className="relative md:w-full xl:h-[450px] lg:h-[355px] md:h-[290px] rounded-md overflow-hidden border">
    ...
    <div className="absolute top-0 left-0 w-full h-full 
     pl-[20px]  md:pb-[0px] md:pl-[80px]">
      ...
      <Link href="/all-products"> <button className="bg-[#80b500] rounded-lg text-sm mt-16 md:text-base flex justify-center text-white items-center gap-2 md:py-2 md:px-6 py-[4px] px-3">
        Shop Now <MoveRight />{" "}
      </button></Link>
...
<div className="col-span-2 group border">
  <div className=" overflow-hidden rounded-md xl:h-[450px] lg:h-[355px] md:h-[290px] object-scale-down">
    <Image
      className="rounded-md transition-transform w-full duration-500 ease-in-out transform group-hover:scale-105 object-scale-down"
      src="/gooq9zvo.png"
      width={400}
      height={50}
      alt="banner"
    />
      ...
      <div>
        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-5 gap-4 md:mt-8 ">
        <div className="col-span-1 group border">
